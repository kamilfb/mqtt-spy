...
public class SimpleMqttMessage implements CopyTo, Copyable, Equals, HashCode, ToString
{
    ...
    public Object copyTo(Object target, CopyBuilder copyBuilder) {
        final SimpleMqttMessage copy = ((target == null)?((SimpleMqttMessage) createCopy()):((SimpleMqttMessage) target));
        {
            String sourceValue;
