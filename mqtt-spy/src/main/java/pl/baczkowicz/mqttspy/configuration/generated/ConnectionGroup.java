 ...
 *         &lt;element name="Parent" type="{http://baczkowicz.pl/mqtt-spy-configuration}ConnectionGroupReference" minOccurs="0"/&gt;
 *         &lt;element name="Subgroups" type="{http://baczkowicz.pl/mqtt-spy-configuration}ConnectionGroupReference" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="Connections" type="{http://baczkowicz.pl/mqtt-spy-configuration}ConnectionReference" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class ConnectionGroup implements Cloneable, CopyTo, Equals, HashCode, ToString
{
    ...
    protected ConnectionGroupReference parent;
     ...
     * 
     */
    public ConnectionGroup(final String id, final String name, final ConnectionGroupReference parent, final List<ConnectionGroupReference> subgroups, final List<ConnectionReference> connections) {
        this.id = id;
        this.name = name;
        this.parent = parent;
     ...
     *     
     */
    public ConnectionGroupReference getParent() {
        return parent;
    }
     ...
     *     
     */
    public void setParent(ConnectionGroupReference value) {
        this.parent = value;
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        {
            ConnectionGroupReference theParent;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        {
            ConnectionGroupReference lhsParent;
            lhsParent = this.getParent();
            ConnectionGroupReference rhsParent;
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof ConnectionGroup) {
            ...
            if (this.parent!= null) {
                ConnectionGroupReference sourceParent;
                sourceParent = this.getParent();
                ConnectionGroupReference copyParent = ((ConnectionGroupReference) strategy.copy(LocatorUtils.property(locator, "parent", sourceParent), sourceParent));
