...
// Generated on: 2015.08.14 at 11:13:33 PM BST 
//
 ...
 *       &lt;sequence&gt;
 *         &lt;element name="ConnectionGroup" type="{http://baczkowicz.pl/mqtt-spy-configuration}ConnectionGroupReference" minOccurs="0"/&gt;
    ...
    implements Cloneable, CopyTo, Equals, HashCode, ToString
{
    ...
    @XmlElement(name = "ConnectionGroup")
    protected ConnectionGroupReference connectionGroup;
     ...
     * 
     */
    public UserInterfaceMqttConnectionDetails(final ConnectionGroupReference connectionGroup, final List<PublicationDetails> publication, final List<TabbedSubscriptionDetails> subscription, final UserAuthenticationOptions userAuthentication, final Boolean autoOpen, final Boolean autoConnect, final Boolean autoSubscribe, final Object formatter, final Integer minMessagesStoredPerTopic, final Integer maxMessagesStored, final String publicationScripts, final String searchScripts, final List<ScriptDetails> backgroundScript, final MessageLog messageLog) {
     ...
     *     
     */
    public ConnectionGroupReference getConnectionGroup() {
     ...
     *     
     */
    public void setConnectionGroup(ConnectionGroupReference value) {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        {
            ConnectionGroupReference theConnectionGroup;
            theConnectionGroup = this.getConnectionGroup();
            strategy.appendField(locator, this, "connectionGroup", buffer, theConnectionGroup);
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        {
            ConnectionGroupReference lhsConnectionGroup;
            lhsConnectionGroup = this.getConnectionGroup();
            ConnectionGroupReference rhsConnectionGroup;
            rhsConnectionGroup = that.getConnectionGroup();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "connectionGroup", lhsConnectionGroup), LocatorUtils.property(thatLocator, "connectionGroup", rhsConnectionGroup), lhsConnectionGroup, rhsConnectionGroup)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = super.hashCode(locator, strategy);
        {
            ConnectionGroupReference theConnectionGroup;
            theConnectionGroup = this.getConnectionGroup();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "connectionGroup", theConnectionGroup), currentHashCode, theConnectionGroup);
        }
        {
            List<PublicationDetails> thePublication;
            thePublication = (((this.publication!= null)&&(!this.publication.isEmpty()))?this.getPublication():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof UserInterfaceMqttConnectionDetails) {
            ...
            if (this.connectionGroup!= null) {
                ConnectionGroupReference sourceConnectionGroup;
                sourceConnectionGroup = this.getConnectionGroup();
                ConnectionGroupReference copyConnectionGroup = ((ConnectionGroupReference) strategy.copy(LocatorUtils.property(locator, "connectionGroup", sourceConnectionGroup), sourceConnectionGroup));
                copy.setConnectionGroup(copyConnectionGroup);
            } else {
                copy.connectionGroup = null;
            }
