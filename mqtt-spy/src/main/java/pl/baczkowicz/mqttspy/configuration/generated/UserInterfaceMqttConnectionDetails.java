    ...
    implements Cloneable, CopyTo, Equals, HashCode, ToString
{
     ...
     * 
     */
    public UserInterfaceMqttConnectionDetails(final ConnectionGroupReference group, final List<PublicationDetails> publication, final List<TabbedSubscriptionDetails> subscription, final UserAuthenticationOptions userAuthentication, final Boolean autoOpen, final Boolean autoConnect, final Boolean autoSubscribe, final Object formatter, final Integer minMessagesStoredPerTopic, final Integer maxMessagesStored, final String publicationScripts, final String searchScripts, final List<ScriptDetails> backgroundScript, final MessageLog messageLog) {
        this.group = group;
